# This Makefile is for the OX::OAuth extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/OX/OAuth.pm]
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/OX/OAuth.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/OX
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/OX
...
TO_INST_PM = lib/OX/OAuth.pm

PM_TO_BLIB = lib/OX/OAuth.pm \
	blib/lib/OX/OAuth.pm
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/OX/OAuth.pm $(INST_MAN3DIR)/OX::OAuth.$(MAN3EXT) 
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/OX/OAuth.pm blib/lib/OX/OAuth.pm 
